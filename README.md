## gazebo_ros_pkgs7 (indigo) - 2.4.11-1

The packages in the `gazebo_ros_pkgs7` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --track indigo --ros-distro indigo gazebo_ros_pkgs7 --edit` on `Tue, 23 Aug 2016 00:21:20 -0000`
...
Version of package(s) in repository `gazebo_ros_pkgs7`:
...
## gazebo_ros_pkgs7 (indigo) - 2.4.11-0

The packages in the `gazebo_ros_pkgs7` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --track indigo --ros-distro indigo gazebo_ros_pkgs7 --edit` on `Tue, 23 Aug 2016 00:03:53 -0000`
...
## gazebo7_ros_pkgs (indigo) - 2.4.9-1

The packages in the `gazebo7_ros_pkgs` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --track indigo --ros-distro indigo gazebo7_ros_pkgs` on `Tue, 26 Jan 2016 18:44:02 -0000`
...
## gazebo7_ros_pkgs (jade) - 2.5.1-1

The packages in the `gazebo7_ros_pkgs` repository were released into the `jade` distro by running `/usr/bin/bloom-release --track jade --ros-distro jade gazebo7_ros_pkgs` on `Tue, 26 Jan 2016 18:29:13 -0000`
